...
✅ **Kết quả mong đợi**: Status 200, response JSON có `"status": "healthy"`
...
✅ **Kết quả mong đợi**: User profile được tạo trong DynamoDB table
...
✅ **Kết quả mong đợi**: Login thành công, nhận được JWT tokens
...
✅ **Kết quả mong đợi**: Profile được update thành công trong DynamoDB
...
✅ **Kết quả mong đợi**: Posts, likes, comments được lưu trong DynamoDB
...
✅ **Kết quả mong đợi**: Friend requests được tạo với status "pending"
...
✅ **Kết quả mong đợi**: Recipes được lưu trong DynamoDB với proper structure
...
✅ **Kết quả mong đợi**: File được upload lên S3 và serve qua CloudFront
...
⚠️ **Lưu ý**: Admin endpoints require user có group "Admins" trong Cognito User Pool
...
✅ **Kết quả mong đợi**: Messages được process bởi worker Lambdas
...
| Endpoint | Thời gian mong đợi | Ghi chú |
|----------|--------------|-------|
...
Tiếp tục: [5.09 - Push to GitLab](../5.09-push-gitlab/)
...
**3. Xác minh Update trong DynamoDB**
...
#### Bước 11: Test Search (OpenSearch)
...
#### Bước 12: Test Admin Features

**1. Liệt kê Users (Admin Only)**
...
- [ ] Profile CRUD operations hoạt động
- [ ] Posts có thể được tạo
- [ ] Posts có thể được liked
- [ ] Comments có thể được thêm
- [ ] Recipes có thể được tạo
- [ ] AI recipe generation hoạt động
- [ ] Ingredient translation hoạt động
- [ ] File upload lên S3 hoạt động
- [ ] CloudFront phục vụ files
- [ ] Search hoạt động (nếu OpenSearch enabled)
- [ ] SQS queues xử lý messages
- [ ] Tất cả Lambda functions thực thi không lỗi
...
Sau khi tất cả tests pass, tiến hành [Push to GitLab](../5.9-push-gitlab/) để version control code của bạn và thiết lập CI/CD.
